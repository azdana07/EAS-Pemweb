...
include 'koneksi.php';
$id = $_GET['id'];
$sql = "SELECT * FROM ibu WHERE id=$id";
...
if(isset($_POST['nama'])){
    ...
    $value = implode(', ', $value);
    $sql = "UPDATE ibu "."  SET ".$value." WHERE id=$id";
        ...
        <form action="" method="post">
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <input type="number" id="usia-kandungan" placeholder="Masukkan Usia Kandungan" name="usia_hamil" required value="<?= $data['usia_hamil'] ?>">

                    <label for="kehamilan-ke">Kehamilan ke-:</label>
                    <input type="number" id="kehamilan-ke" placeholder="0" name="hamil_ke" required value="<?= $data['hamil_ke'] ?>">
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <div class="question-group">
                        ...
                        <div class="options">
                            <label><input type="radio" name="q2" required value="1" <?= $data['q2'] == '1' ? 'checked' : '' ?> > Ya</label>
                            <label><input type="radio" name="q2" required value="0"     <?= $data['q2'] == '0' ? 'checked' : '' ?> > Tidak</label>
                        </div>
                    </div>
                    ...
                    <div class="question-group">
                        ...
                        <div class="options">
                            <label><input type="radio" name="q3" required value="1" <?= $data['q3'] == '1' ? 'checked' : '' ?> > Ya</label>
                            <label><input type="radio" name="q3" required value="0" <?= $data['q3'] == '0' ? 'checked' : '' ?> > Tidak</label>
                        </div>
                    </div>
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <textarea id="catatan-pertumbuhan" name="c1" required
                        placeholder="Catat hal-hal penting terkait kesehatan ibu dan perkembangan janin"><?= $data['c1'] ?></textarea>
                    ...
                    <textarea id="catatan-rencana" name="c2" required
                        placeholder="Catat hal-hal penting terkait rencana tindak lanjut terhadap Ibu dan calon bayi"><?= $data['c2'] ?></textarea>
                </div>
            </div>
    </div>
    <div class="container">
